...
class Engine:
    ...
    def log_dynamics_output(self, logger: sim_logger.Logger, dynamics_output: interface.DynamicsOutput):
        ...
        logger.buffer["rotor_0_sensed_wind_velocity"].append(dynamics_output.rotors.rotors[0].sensed_wind_velocity.copy())
        logger.buffer["rotor_1_sensed_wind_velocity"].append(dynamics_output.rotors.rotors[1].sensed_wind_velocity.copy())
        logger.buffer["rotor_2_sensed_wind_velocity"].append(dynamics_output.rotors.rotors[2].sensed_wind_velocity.copy())
        logger.buffer["rotor_3_sensed_wind_velocity"].append(dynamics_output.rotors.rotors[3].sensed_wind_velocity.copy())
